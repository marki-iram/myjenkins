...
@Controller
public class StadeZoneAdminController {
	
	 @Autowired
	  private StadeZoneRepository tutorialRepository;

	  @GetMapping("/tutorials")
	  public String getAll(Model model, @Param("keyword") String keyword) {
	    try {
	      List<StadeZone> tutorials = new ArrayList<StadeZone>();
	  ...
	  public String addTutorial(Model model) {
		  StadeZone tutorial = new StadeZone();
	  ...
	  public String saveTutorial(StadeZone tutorial, RedirectAttributes redirectAttributes) {
	    try {
	  ...
	  public String editTutorial(@PathVariable("id") Long id, Model model, RedirectAttributes redirectAttributes) {
	    try {
	    	StadeZone tutorial = tutorialRepository.findById(id).get();
